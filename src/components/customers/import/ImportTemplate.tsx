  ...
  const templateConfigs = {
    companies: {
      ...
      validationRules: [
        ...
        'البريد الإلكتروني: اختياري، تنسيق email صحيح',
        'رقم الهاتف: اختياري، أرقام ورموز فقط',
        'العنوان: اختياري، أقل من 200 حرف',
        'المدينة: اختياري، يجب أن تكون من المدن السعودية',
    ...
    branches: {
      ...
      validationRules: [
        ...
        'فريق العمل المختص: اختياري، أقل من 100 حرف',
        'ملاحظات: اختياري، أقل من 500 حرف'
      ]
    }
  };
